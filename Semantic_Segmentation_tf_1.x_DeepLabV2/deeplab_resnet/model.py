...
class DeepLabResNetModel(Network):
    def setup(self, is_training, num_classes):
        ...
        (self.feed('res5a_relu', 
             ...
             .dropout(keep_prob=0.5, name="drop_res5a"))
        
        
        (self.feed('res5b_relu', 
                   'drop_res5a')
             .add(name='conv5_3_pool1')
             .relu(name='res5c_relu'))
            
        (self.feed('res5c_relu')
             .avg_pool(60,60, 60, 60, name='conv5_3_pool1')
             .conv(1, 1, 512, 1, 1, biased=False, relu=False, name='conv5_3_pool1_conv')
             .batch_normalization(is_training=is_training, activation_fn=tf.nn.relu, name='conv5_3_pool1_conv/bn_relu'))
             

        (self.feed('res5c_relu')
             .avg_pool(30,30, 30, 30, name='conv5_3_pool2')
             .conv(1, 1, 512, 1, 1, biased=False, relu=False, name='conv5_3_pool2_conv')
             .batch_normalization(is_training=is_training, activation_fn=tf.nn.relu, name='conv5_3_pool2_conv/bn_relu'))
             
        (self.feed('res5c_relu')
             .avg_pool(20,20,20,20, name='conv5_3_pool3')
             .conv(1, 1, 512, 1, 1, biased=False, relu=False, name='conv5_3_pool3_conv')
             .batch_normalization(is_training=is_training, activation_fn=tf.nn.relu, name='conv5_3_pool3_conv/bn_relu'))
             
        
        (self.feed('res5c_relu')
             .avg_pool(10,10,10,10, name='conv5_3_pool6')
             .conv(1, 1, 512, 1, 1, biased=False, relu=False, name='conv5_3_pool6_conv')
             .batch_normalization(is_training=is_training, activation_fn=tf.nn.relu, name='conv5_3_pool6_conv/bn_relu'))

        
        (self.feed('res3b3_relu')
             .avg_pool(60,60, 60, 60, name='res3b3_relu_pool1')
             .conv(1, 1, 512, 1, 1, biased=False, relu=False, name='res3b3_relu_pool1_conv')
             .batch_normalization(is_training=is_training, activation_fn=tf.nn.relu, name='res3b3_relu_pool1_conv/bn_relu'))
             

        (self.feed('res3b3_relu')
             .avg_pool(30,30, 30, 30, name='res3b3_relu_pool2')
             .conv(1, 1, 512, 1, 1, biased=False, relu=False, name='res3b3_relu_pool2_conv')
             .batch_normalization(is_training=is_training, activation_fn=tf.nn.relu, name='res3b3_relu_pool2_conv/bn_relu'))
             
        (self.feed('res3b3_relu')
             .avg_pool(20,20,20,20, name='res3b3_relu_pool3')
             .conv(1, 1, 512, 1, 1, biased=False, relu=False, name='res3b3_relu_pool3_conv')
             .batch_normalization(is_training=is_training, activation_fn=tf.nn.relu, name='res3b3_relu_pool3_conv/bn_relu'))
             
        
        (self.feed('res3b3_relu')
             .avg_pool(10,10,10,10, name='res3b3_relu_pool6')
             .conv(1, 1, 512, 1, 1, biased=False, relu=False, name='res3b3_relu_pool6_conv')
             .batch_normalization(is_training=is_training, activation_fn=tf.nn.relu, name='res3b3_relu_pool6_conv/bn_relu'))
        ...
        (self.feed('fc1_voc12_c0', 
             ...
             .add(name='fc1_voc12'))
        '''
#.dropout(0.5,name="conv5_4/dropout"))
class bottom_net(Network):
    def setup(self,is_training, num_classes):


             (self.feed('conv5_3_concat')
             .conv(3,3, 512, 1, 1, biased=False, relu=False, name='conv5_4')
             .batch_normalization(is_training=is_training, activation_fn=tf.nn.relu, name='conv5_4/bn_relu'))
             

             (self.feed('conv5_4/bn_relu')
             .conv(3,3, num_classes, 1, 1, biased=False, relu=False, name='conv6'))
