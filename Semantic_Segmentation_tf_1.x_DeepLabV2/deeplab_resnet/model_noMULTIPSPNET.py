...
class DeepLabResNetModel(Network):
    def setup(self, is_training, num_classes):
        ...
        (self.feed('res5c_relu')
             .avg_pool(29,29, 29, 29, name='conv5_3_pool1')
        ...
        (self.feed('res5c_relu')
             .avg_pool(15,15, 15, 15, name='conv5_3_pool2')
        ...
        (self.feed('res5c_relu')
             .avg_pool(10,10,10,10, name='conv5_3_pool3')
        ...
        (self.feed('res5c_relu')
             .avg_pool(5,5,5,5, name='conv5_3_pool6')
