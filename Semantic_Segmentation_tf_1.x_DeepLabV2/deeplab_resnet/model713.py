...
class DeepLabResNetModel(Network):
    def setup(self, is_training, num_classes):
        ...
        (self.feed('res3b3_relu')
             .avg_pool(90,90, 90, 90, name='res3b3_relu_pool1')
        ...
        (self.feed('res3b3_relu')
             .avg_pool(45,45, 45, 45, name='res3b3_relu_pool2')
        ...
        (self.feed('res3b3_relu')
             .avg_pool(30,30,30,30, name='res3b3_relu_pool3')
        ...
        (self.feed('res3b3_relu')
             .avg_pool(15,15,15,15, name='res3b3_relu_pool6')
