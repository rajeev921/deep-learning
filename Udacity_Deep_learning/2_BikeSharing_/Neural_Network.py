...
Hint: You'll need the derivative of the output activation function ( 𝑓(𝑥)=𝑥 ) for the backpropagation implementation. If you aren't familiar with calculus, this function is equivalent to the equation  𝑦=𝑥 . What is the slope of that equation? That is the derivative of  𝑓(𝑥) .
